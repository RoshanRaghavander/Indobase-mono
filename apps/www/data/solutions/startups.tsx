...
const data: () => {
  ...
  return {
    metadata: {
      metaTitle: 'IndoBase for Startups',
      metaDescription: 'Build fast. Scale easily. Trust your stack.',
    },
    heroSection: {
      id: 'hero',
      title: 'IndoBase for Startups',
      h1: (
        <>
      ...
      subheader: [
        <>
          The Postgres development platform. IndoBase is the powerful, scalable backend that lets
    ...
    why: {
      ...
      heading: (
        <>
          Why <span className="text-foreground">startups</span> choose IndoBase
        </>
      ),
      subheading:
        'Speed wins. IndoBase helps you move faster by providing a full-featured, scalable backend based on Postgres.',
      features: [
        {
