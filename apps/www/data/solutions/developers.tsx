...
const data: () => {
  ...
  return {
    metadata: {
      metaTitle: 'IndoBase for Developers',
      metaDescription: 'Build fast. Scale easily. Trust your tech stack.',
    },
    heroSection: {
      id: 'hero',
      title: 'IndoBase for Developers',
      h1: (
        <>
      ...
      subheader: [
        <>
          IndoBase is the Postgres development platform that includes a developer experience
    ...
    why: {
      ...
      heading: (
        <>
          Why <span className="text-foreground">developers</span> choose IndoBase
        </>
      ),
      subheading:
        'IndoBase helps you build and get to market faster and more cost-effectively using a composable platform of application services built on Postgres. IndoBase scales as your business grows.',
      features: [
        {
          id: 'easy-to-use',
          icon: Timer,
        ...
        },
        {
          ...
          subheading:
            'Built on Postgres, IndoBase provides enterprise-grade performance, high availability, and the flexibility to grow without vendor lock-in.',
        },
      ],
    },
    platform: {
...
- The generated SQL must be valid SQL.`,
  ...
  "mcpServers": {
    "indobase": {
      "url": "https://mcp.indobase.com/mcp"
    }
  }
}`,
        },
