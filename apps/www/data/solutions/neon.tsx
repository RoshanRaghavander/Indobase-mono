...
const data = {
  metadata: {
    metaTitle: 'Switch from Neon to IndoBase',
    metaDescription:
      'The complete Postgres development platform Neon users prefer. IndoBase is a composable stack for modern applications: Postgres Database, built-in Auth, Real-time sync, Edge Functions, Storage, and a powerful developer experience.',
  },
  heroSection: {
    id: 'hero',
    title: 'Moving from Neon to IndoBase',
    ...
    h1: 'Neon users switch to IndoBase for a complete Postgres experience',
    subheader: [
      <>
        IndoBase is a composable stack for modern applications: Postgres Database, built-in Auth,
        Real-time sync, Edge Functions, Storage, and a powerful developer experience.
      </>,
      <>
        IndoBase is the preferred foundation for high-performance, high-scale SaaS, AI-native apps,
    ...
    ctas: [
      {
        ...
        href: 'https://indobase.com/docs/guides/platform/migrating-to-indobase/neon',
        type: 'primary' as any,
    ...
    image: (
      <Image
        ...
        alt="Neon to IndoBase illustration"
        width={1000}
        height={1000}
  ...
  quote: {
    ...
    text: 'We wanted a backend that could accelerate our development while maintaining security and scalability. IndoBase stood out due to its automation, integrations, and ecosystem.',
  ...
  why: {
    ...
    heading: (
      <>
        Why companies moved <span className="text-foreground">to IndoBase from Neon</span>
      </>
    ),
    subheading:
    ...
    features: [
      ...
      },
      {
        ...
        subheading:
          'IndoBase runs on standard Postgres with full SQL, ACID guarantees, PITR, and high availability. Designed for reliable, stateful agent workloads.',
      },
      {
        id: 'migration',
        icon: ArrowRight,
        heading: 'Migrate from Neon with ease',
        subheading: 'IndoBase is Postgres. Moving from Neon is a breeze.',
      },
    ],
  },
  platform: {
    ...
    title: (
      <>
        IndoBase is the Postgres platform <span className="text-foreground">you control</span>
      </>
    ),
    subheading: "IndoBase includes everything you've come to expect from Neon, and so much more.",
    features: [
      {
        id: 'database',
        title: 'Database',
  ...
  ctaSection: {
    ...
    title: (
      <>
        Migrate your Neon database to IndoBase to{' '}
    ...
    primaryCta: {
      ...
      url: 'https://indobase.com/docs/guides/platform/migrating-to-indobase/neon',
      target: '_blank',
      icon: <ArrowUpRight className="w-4 h-4 text-current" />,
    },
  },
