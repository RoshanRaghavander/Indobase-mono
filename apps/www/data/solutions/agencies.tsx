...
const data: {
  ...
  metadata: {
    metaTitle: 'IndoBase for Agencies',
    metaDescription:
  ...
  heroSection: {
    id: 'hero',
    title: 'IndoBase for Agencies',
    h1: <>IndoBase for Agencies</>,
    subheader: [
      <>
      ...
      <>
        ...
        accumulating technical debt. IndoBase gives you a fully managed Postgres backend with
    ...
    items: [
        ...
        quote: (
          <>
            <span className="text-foreground">
              Our clients want reliability and scale. IndoBase gives us a backend we can trust for
              production work.
            </span>
          </>
        ),
      },
      {
        ...
        quote: (
          <>
            <span className="text-foreground">
              IndoBase lets us build stable, secure products extremely fast.
            </span>
          </>
        ),
      },
      {
        ...
        quote: (
          <>
            <span className="text-foreground">
              IndoBase brings structure and clarity to our backend work. Its interface and tooling
      ...
      },
      {
        ...
        quote: (
          <>
            <span className="text-foreground">
              IndoBase is our go-to backend for client work because it&apos;s fast to build with and
              easy to maintain.
            </span>
          </>
        ),
  ...
  why: {
    ...
    heading: (
      <>
        Why <span className="text-foreground">agencies</span> choose IndoBase
      </>
    ),
    subheading:
      'You want to deliver exceptional results for your clients while staying profitable and competitive. At the same time, you need the flexibility to customize solutions and the confidence that your applications will scale. IndoBase is the complete Postgres developer platform of choice for agencies building production applications.',
    features: [
      {
        id: 'ship-faster',
        icon: Timer,
        ...
        subheading:
          'Deliver production-ready applications in weeks, not months. IndoBase provides a complete backend with auto-generated APIs and built-in features, letting you focus on what makes each client project unique rather than rebuilding the same infrastructure every time.',
      },
      {
        ...
        subheading:
          'Give clients enterprise-grade security and compliance without the enterprise complexity. IndoBase is “just Postgres,” offering SOC 2 and HIPAA compliance out of the box so their applications are built on battle-tested, portable technology they can grow with.',
      },
      {
        id: 'maintain-scale',
        icon: (props: any) => (
        ...
        subheading:
          'Reduce ongoing maintenance and keep clients happy long after launch. Applications built on IndoBase are ready to handle growth, with read replicas, HA architecture, and flexible tooling so you can support every phase of a client engagement.',
      },
    ],
  },
  platform: {
    ...
    subheading:
      'IndoBase includes everything you need to deliver complete, production-ready applications for your clients.',
    features: [
      {
        id: 'database',
        title: 'Database',
  ...
  developerExperience: {
    ...
    title: (
      <>
        <span className="text-foreground">Build faster</span> with IndoBase
      </>
    ),
    ...
    features: [
      {
        ...
        subheading: (
          <>
            A single panel that persists across the IndoBase Dashboard and maintains{' '}
      ...
      },
      {
        ...
        subheading: (
          <>
            ...
            Windsurf, Claude, and more—directly with IndoBase.
          </>
        ),
        image: (
          <Image
      ...
      },
      {
        ...
        subheading: (
          <>
            ...
            IndoBase generates automatic APIs so your teams can stay focused on UX.
          </>
        ),
        image: (
          <Image
      ...
      },
      {
        ...
        subheading: (
          <>
            Connect IndoBase to <span className="text-foreground">Redshift, BigQuery, MySQL</span>{' '}
  ...
  resultsSection: {
    ...
    subheading:
      'IndoBase ensures optimal database performance at any scale, so you can confidently promise your clients reliable, fast applications without worrying about infrastructure limitations.',
    highlights: [
      {
  ...
  securitySection: {
    ...
    subheading:
      'Support a full range of potential clients. IndoBase offers enterprise-grade security with SOC 2, HIPAA, and GDPR compliance. Client data is encrypted at rest and in transit, with built-in tools for monitoring and managing security threats.',
    features: [
  ...
  partnerships: {
    ...
    subheading:
      'IndoBase integrates with a vibrant partner ecosystem, allowing your agency to assemble best-in-class solutions for every client.',
    features: [
      {
        icon: Sparkles,
        heading: 'Accelerate development with AI builders',
        subheading:
          'Turn visual prototypes into production-ready applications by connecting front-end tools like Lovable and Bolt to a real IndoBase, open-source Postgres backend.',
      },
      {
        icon: Lightbulb,
      ...
      },
      {
        ...
        subheading:
          "Foreign Data Wrappers link IndoBase to your clients' existing data sources, allowing you to build applications that integrate seamlessly with their current infrastructure.",
      },
    ],
  },
    ...
    aiPrompts: [
      {
        ...
        description:
          '## Overview of implementing IndoBase Auth SSR\n1. Install @supabase/supabase-js and...',
...
`,
        language: 'markdown',
        docsUrl: 'https://indobase.com/docs/guides/getting-started/ai-prompts/nextjs-indobase-auth',
      },
      {
        id: 'edge-functions',
        title: 'Writing IndoBase Edge Functions',
        description:
          "You're a IndoBase Postgres expert in writing row level security policies. Your purpose is to generate...",
