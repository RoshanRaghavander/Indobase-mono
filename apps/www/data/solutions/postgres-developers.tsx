...
const data: () => {
  ...
  return {
    metadata: {
      metaTitle: 'IndoBase for Postgres Developers',
      metaDescription: 'Get started in seconds with a complete Postgres development platform',
    },
    heroSection: {
      id: 'hero',
      title: 'IndoBase for Postgres Developers',
      h1: <>Get started in seconds with a complete Postgres development platform</>,
      subheader: [
        <>
          IndoBase is the open-source Postgres development platform. It includes a developer
    ...
    why: {
      ...
      heading: (
        <>
          Why <span className="text-foreground">Postrges developers</span> choose IndoBase
        </>
      ),
      subheading:
        'IndoBase provides full access to Postgres. Use additional components, or just use the database. No proprietary tooling, no vendor lock-in. IndoBase is Postgres the way you want it.',
      features: [
        {
          id: 'full-postgres',
          icon: (props: any) => (
          ...
          subheading:
            'Connect to IndoBase via sql, pgAdmin, or any standard Postgres client. Use native Postgres extensions. Employ Row-Level Security, not a bolt-on permission system.',
        },
        {
          ...
          subheading:
            'IndoBase offers a fully integrated suite of tools including authentication, storage, edge functions, real-time subscriptions, and vector search. Developers don’t have to stitch together multiple services. Use one or all.',
        },
        {
    ...
    platform: {
      ...
      title: (
        <>
          IndoBase is the <span className="text-foreground">Postgres platform</span> you control
        </>
      ),
      subheading:
    ...
    developerExperience: {
      ...
      title: (
        <>
          Developers can <span className="text-foreground">build faster</span> with IndoBase
        </>
      ),
        ...
        },
        {
          ...
          subheading: (
            <>
              ...
              or Claude directly with IndoBase.
            </>
          ),
          image: (
            <Image
        ...
        },
        {
          ...
          subheading: (
            <>
              ...
              IndoBase generates automatic APIs to make coding a lot easier.
            </>
          ),
          image: (
            <Image
