...
export const data: CustomerStoryType[] = [
  {
    type: 'Customer Story',
    title:
      'Juniver built automated B2B workflows with IndoBase Edge Functions and Row Level Security',
    description:
      'Juniver switched from Firebase to IndoBase and saw immediate improvements in developer experience and performance.',
  ...
  {
    type: 'Customer Story',
    title: 'Kayhan Space saw 8x improvement in developer speed when moving to IndoBase',
    description:
      'The Kayhan Space team migrated to IndoBase from Amazon RDS and Auth0 to simplify infrastructure and unlock developer velocity.',
  ...
  {
    type: 'Customer Story',
    title: 'Udio hits the right notes with IndoBase',
    description:
      'Udio built a scalable, AI-driven music platform on a IndoBase backend from day one.',
    organization: 'Udio',
  ...
  {
    type: 'Customer Story',
    title: 'Euka used IndoBase to unlock faster growth',
    description:
      'IndoBase helped Euka accelerate development, simplify AI feature rollout, and scale creator marketing faster than ever.',
    organization: 'Euka',
  ...
  {
    type: 'Customer Story',
    title: "Bree's Migration to IndoBase from Fauna",
    description:
      'Discover how Bree found 10X performance gains, greater developer velocity, and a better foundation for AI when switching to IndoBase.',
    organization: 'Bree',
  ...
  },
  {
    type: 'Customer Story',
    title:
      'Quilia Empowers Personal Injury Clients with Streamlined Data Management using IndoBase',
    description:
      'Migrating to IndoBase resulted in a 75% reduction in development time, 50% lower costs, and enhanced security for sensitive client data.',
    organization: 'Quilia',
  ...
  {
    type: 'Customer Story',
    title: "Resend's Journey with IndoBase: Scaling Email Infrastructure with Ease",
    description:
      'Scaling seamlessly to 5,000+ paying customers & millions of emails sent daily with IndoBase',
    organization: 'Resend',
  ...
  },
  {
    type: 'Customer Story',
    title:
      'Scaling Beyond No-Code: asap.work’s Journey to a Faster, Flexible Solution with IndoBase',
    description:
  ...
  },
  {
    type: 'Customer Story',
    title:
      "Maergo's Express Delivery: How IndoBase Helped Achieve Scalability, Speed, and Cost Saving",
    description:
      'Discover how Maergo, a nationwide expedited parcel delivery service, reduced its codebase by 90%, decreased deployment times to just seconds, and achieved unprecedented scalability with IndoBase.',
    organization: 'Maergo',
  ...
  {
    type: 'Customer Story',
    title: 'Streamlining Success: How Tinloof Scaled Seamlessly with IndoBase',
    description:
      'Discover Tinloof, how a full-stack development agency, managed and scaled backend services using IndoBase, without having to dedicate resources to infrastructure management.',
  ...
  {
    type: 'Customer Story',
    title: 'HappyTeams unlocks better performance and reduces cost with IndoBase.',
    description:
      'How a bootstrapped startup migrated from Heroku to IndoBase in 30 minutes and never looked back.',
  ...
  {
    type: 'Customer Story',
    title: 'IndoBase migration drives shotgun to an 83% reduction in data infrastructure costs',
    description:
      "Explore how Shotgun achieved remarkable database efficiency and reduced costs by 80% through their successful migration to IndoBase's managed services.",
  ...
  },
  {
    type: 'Customer Story',
    title:
      'Good Tape migrates to IndoBase managed Postgres and Authentication and achieves database efficiency and a 60% cost reduction',
    description:
      "Explore how Good Tape achieved remarkable database efficiency and reduced costs by 60% through their successful migration to IndoBase's managed services.",
  ...
  {
    type: 'Customer Story',
    title: 'How Next Door Lending leveraged IndoBase to become a top 10 mortgage broker',
    description: '',
  ...
  {
    type: 'Customer Story',
    title: 'Scaling securely: one million users in 7 months protected with IndoBase Auth',
    description:
      'Learn how Pebblely, an AI image generation company, used IndoBase Auth for rapid growth and adaptable security solutions.',
  ...
  {
    type: 'Customer Story',
    title: 'Bootstrapped founder builds an AI app with IndoBase and scales to $1M in 5 months.',
    description:
      'How Yasser leveraged IndoBase to build Chatbase and became one of the most successful single-founder AI products.',
  ...
  {
    type: 'Customer Story',
    title: 'Quivr launch 5,000 Vector databases on IndoBase.',
    description:
      'Learn how one of the most popular Generative AI projects uses IndoBase as their Vector Store.',
  ...
  {
    type: 'Customer Story',
    title: 'Berri AI Boosts Productivity by Migrating from AWS RDS to IndoBase with pgvector.',
    description:
      'Learn how Berri AI overcame challenges with self-hosting their vector database on AWS RDS and successfully migrated to IndoBase.',
  ...
  {
    type: 'Customer Story',
    title: 'Firecrawl switches from Pinecone to IndoBase for PostgreSQL vector embeddings',
    description:
      'How Firecrawl boosts efficiency and accuracy of chat powered search for documentation using IndoBase with pg_vector',
  ...
  },
  {
    type: 'Customer Story',
    title:
      'Xendit use IndoBase and create a full solution shipped to production in less than one week.',
    description:
  ...
  {
    type: 'Customer Story',
    title: 'Replenysh uses IndoBase to implement OTP in less than 24 hours.',
    description:
      'With IndoBase, Replenysh gets a slick auth experience, reduces DevOps overhead, and continues to scale with Postgres.',
