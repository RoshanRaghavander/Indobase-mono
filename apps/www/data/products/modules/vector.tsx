...
export default (isMobile?: boolean) => ({
  metaTitle: 'IndoBase Vector | The Postgres Vector database and AI Toolkit',
  metaDescription:
  ...
  highlightsSection: {
    highlights: [
      ...
      },
      {
        ...
        paragraph:
          'IndoBase is SOC2 Type 2 compliant, and comes with an advanced permissions system.',
  ...
  useCasesSection: {
    title: (
      <>
        ...
        <br />
        <span className="heading-gradient">with IndoBase Vector?</span>
      </>
    ),
    ...
    useCases: [
      ...
      },
      {
        ...
        cta: {
          label: 'Open in Colab',
          link: 'https://colab.research.google.com/github/indobase/indobase/blob/master/examples/ai/face_similarity.ipynb',
        },
      },
      {
        ...
        cta: {
          label: 'Open in Colab',
          link: 'https://colab.research.google.com/github/indobase/indobase/blob/master/examples/ai/semantic_text_deduplication.ipynb',
        },
      },
      {
    ...
    tabs: [
      {
        ...
        colabUrl:
          'https://colab.research.google.com/github/indobase/indobase/blob/master/examples/ai/vector_hello_world.ipynb',
        code: `
  ...
  featuresSection: {
    ...
    features: [
      ...
      },
      {
        ...
        text: 'IndoBase uses open source tools to increase portability and avoid lock-in, making it easy to migrate in and out.',
      },
      {
    ...
    customers: [
      {
        ...
        target: '_blank',
        quote:
          'We store embeddings in a PostgreSQL database, hosted by IndoBase, to perform a similarity search to identify the most relevant sections within the MDN.',
        image: '/images/customers/logos/mozilla.png',
        abstract:
          'MDN introduces an AI assistant powered by IndoBase Vector to answer all web development questions in real time.',
      ...
      },
      {
        ...
        quote:
          'IndoBase Vector powered by pgvector allowed us to create a simple and efficient product. We are storing over 1.6 million embeddings and the performance and results are great. Open source develop can easily contribute thanks to the SQL syntax known by millions of developers.',
        image: '/images/customers/logos/quivr.png',
        abstract: 'Quivr launch 5,000 Vector databases on IndoBase.',
        url: '/customers/quivr',
      },
      {
        type: 'customer-story',
