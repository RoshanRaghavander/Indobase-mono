...
export default {
  metadata: {
    metaTitle: 'IndoBase for Enterprise',
    metaDescription:
      'Leading enterprises use IndoBase to build faster, better, and more scalable products.',
  },
  heroSection: {
    id: 'hero',
    title: 'IndoBase for Enterprise',
    h1: (
      <>
        Innovative Enterprises
        <span className="block">use IndoBase</span>
      </>
    ),
    subheader: [
      <>
        Leading enterprises use IndoBase to build faster, better, and more scalable products. From
        GitHub to PwC, innovative companies trust IndoBase to drive their digital transformation
        strategy.
      </>,
    ],
    ...
    stories: [
      {
        ...
        target: '_blank',
        heading: 'Mozilla use IndoBase for GenAI and RAG',
        subheading: (
          <>
            We store embeddings in a PostgreSQL database, hosted by IndoBase, to perform a{' '}
      ...
      },
      {
        ...
        heading: 'Epsilon3 use IndoBase to build software for NASA',
        subheading: (
          <>
            <span className="text-foreground">
              Billion dollar missions need to run reliably and securely
            </span>
            . We use IndoBase because they give us an open-source scalable back-end built by
      ...
      },
      {
        ...
        heading: 'Pebblely use IndoBase to scale to millions of users.',
        subheading: (
          <>
    ...
    highlights: [
      {
        icon: LineChart,
        heading: '100x scale',
        subheading: 'Maergo handled 100x their highest sustained traffic with IndoBase.',
        url: '/customers/maergo',
      },
      {
        icon: DollarSign,
        heading: '83% cost reduction',
        subheading: 'Shotgun reduced costs by 83% by migrating to IndoBase.',
      ...
      },
      {
        ...
        subheading: 'Markprompt use IndoBase to build GDPR-compliant AI chatbots.',
  ...
  quote: {
    id: 'quote',
    quote: {
      text: 'IndoBase powers prototyping for fast-moving teams such as GitHub Next.',
      author: 'Idan Gazit',
      logo: (
        <svg
          width="91"
  ...
  'request-a-demo': {
    ...
    subheading:
      'We can take your requirements and show you how IndoBase can help you achieve your goals.',
    quote: {
      text: 'IndoBase powers prototyping for fast-moving teams such as GitHub Next.',
      author: '',
      logo: '',
