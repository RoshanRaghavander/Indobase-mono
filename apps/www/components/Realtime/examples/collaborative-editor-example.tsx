...
const layoutProps: ExampleLayoutProps = {
  ...
  description:
    "A real-time collaborative text editor that uses IndoBase Realtime's broadcast channel to sync document changes between users via YJS CRDT.",
}
