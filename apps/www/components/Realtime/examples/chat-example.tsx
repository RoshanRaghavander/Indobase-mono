...
const layoutProps: ExampleLayoutProps = {
  ...
  title: 'Chat Example',
  description:
    "A real-time chat application that uses IndoBase Realtime's broadcast and presence features to enable instant messaging and show online users.",
}
