...
export const days: BuildDay[] = [
  {
    ...
    links: [
      {
        url: '/blog/indobase-ui-platform-kit',
        label: 'Blog post',
        target: '_blank',
      },
    ],
  ...
  {
    title: 'Create a IndoBase backend using Figma Make',
    id: 'figma',
    is_shipped: true,
    links: [
      {
        url: '/blog/figma-make-support-for-indobase',
        label: 'Blog post',
        target: '_blank',
      },
    ],
  ...
  },
  {
    ...
    links: [
      {
        url: '/blog/algolia-connector-for-indobase',
        label: 'Blog post',
        target: '_blank',
      },
    ],
