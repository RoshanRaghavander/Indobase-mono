...
toc_depth: 3
author: michel
imgSocial: partitions/dynamic-table-partitioning-og.png
imgThumb: partitions/dynamic-table-partitioning-thumb.png
---
...
[See the full code example on GitHub](https://github.com/indobase/indobase/tree/master/examples/enterprise-patterns/supachat)
