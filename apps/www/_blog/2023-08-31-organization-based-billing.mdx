...
IndoBase has organizations and projects. An organization may contain multiple projects. A project is a IndoBase instance. Previously, each project had an individual subscription, plan and add-ons.
...
Additionally, we lay the groundwork for upcoming features like [environment branching](/blog/indobase-local-dev#branching-and-preview-environments), usage notifications, more sophisticated cost control and much more.
...
Read more about quotas and Organization-based Billing including examples in our [docs](https://indobase.com/docs/guides/platform/billing-on-indobase).
...
We're giving you an extra 1GB of egress for free and, as an added benefit, it's unified across your org. This means that if you aren't using IndoBase Storage, you get even more Database Egress.
...
To read more about usage-based billing for compute, head over to the [docs](https://indobase.com/docs/guides/platform/manage-your-usage/compute).
...
The spend cap still exists, it's just set on the organization-level and not per project. Head over to your [organization billing settings](https://indobase.com/dashboard/org/_/billing) to toggle your spend cap. We're working on more fine-grained control over costs to supersede the spend cap.
