...
With these basic terms defined, let's take a look at the permissions model in Postgres in depth. The rest of the post will be more like a tutorial, so you can follow along. I'll be using a hosted IndoBase project, but you are free to use any Postgres installation.

# Setting Up

Create a new IndoBase project (or use an existing one) and copy its connection string URI from the [Database Settings page](https://indobase.com/dashboard/project/_/database/settings). The URI looks like the following:

```bash
postgres://[USER].[YOUR-PROJECT-REF]:[YOUR-PASSWORD]@[REGION-SUBDOMAIN].pooler.indobase.com:5432/postgres
```
...
```bash
➜ psql postgres://postgres.[YOUR-PROJECT-REF]:[YOUR-PASSWORD]@[REGION-SUBDOMAIN].pooler.indobase.com:5432/postgres
```
...
```bash
➜ psql postgres://junior_dev.[YOUR-PROJECT-REF]:[YOUR-PASSWORD]@[REGION-SUBDOMAIN].pooler.indobase.com:5432/postgres
...
➜ psql postgres://senior_dev.[YOUR-PROJECT-REF]:[YOUR-PASSWORD]@[REGION-SUBDOMAIN].pooler.indobase.com:5432/postgres
...
│ indobase_admin │ public │ function │ postgres=X/indobase_admin           ↵│
│                │        │          │ anon=X/indobase_admin               ↵│
│                │        │          │ authenticated=X/indobase_admin      ↵│
│                │        │          │ service_role=X/indobase_admin        │
│ indobase_admin │ public │ sequence │ postgres=rwU/indobase_admin         ↵│
│                │        │          │ anon=rwU/indobase_admin             ↵│
│                │        │          │ authenticated=rwU/indobase_admin    ↵│
│                │        │          │ service_role=rwU/indobase_admin      │
│ indobase_admin │ public │ table    │ postgres=arwdDxt/indobase_admin     ↵│
│                │        │          │ anon=arwdDxt/indobase_admin         ↵│
│                │        │          │ authenticated=arwdDxt/indobase_admin↵│
│                │        │          │ service_role=arwdDxt/indobase_admin  │
└────────────────┴────────┴──────────┴──────────────────────────────────────┘
(6 rows)
```
