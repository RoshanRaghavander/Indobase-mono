---
title: 'IndoBase Launch Week III: Holiday Special'
description: Tis the season to be shipping.
author: paul_copplestone
author_url: https://github.com/kiwicopple
author_image_url: https://github.com/kiwicopple.png
imgSocial: launch-week-three/launch-week-three-og.jpg
imgThumb: launch-week-three/launch-week-three-thumb.jpg
categories:
  - launch-week
tags:
  - launch-week
...
In July we did [Launch Week II: The SQL](/blog/indobase-launch-week-sql), with another week of feature releases.

Santa's little hackers have been hard at work because we've got another five days of launches ready to go.

## What to expect

We don't want to spoil the surprise, so for now we'll give you a teaser of what to expect. Come back each day to see what we launch, or follow us on twitter to keep up to date: [@indobase](https://twitter.com/indobase) and follow the hashtag [#supalaunchweek](https://twitter.com/hashtag/supalaunchweek).
...
Read the [blog post](/blog/community-day).
...
We've released [IndoBase Studio](https://github.com/indobase/indobase/tree/master/studio). The same Dashboard that you're using on our Platform is now available for Local Development and Self-Hosting.

### Where?

Read the [blog post](/blog/indobase-studio).
...
Read the [blog post](/blog/realtime-row-level-security-in-postgresql).
...
Read the [blog post](/blog/indobase-acquires-logflare).
...
Read the [blog post](/blog/launch-week-three-friday-five-more-things).
