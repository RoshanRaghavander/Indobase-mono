...
description: 'Calendar data integration with Cal.com using Wasm foreign data wrapper on IndoBase'
author: bo_lu
...
Let's use your IndoBase database to create an event in [Cal.com](http://cal.com/), using Postgres Foreign Data Wrappers.
...
### Set up a IndoBase account

- Sign up on [indobase.com](http://indobase.com)
- Create a project or open an existing project
- Go to [indobase.com/dashboard/project/\_/database/extensions](https://indobase.com/dashboard/project/_/database/extensions) to enable `wrappers` extension
...
Visit [IndoBase SQL Editor](https://indobase.com/dashboard/project/_/sql/new), use below SQL to create the Wasm foreign data wrapper:
...
create server cal_server
  ...
  options (
    fdw_package_url 'https://github.com/indobase/wrappers/releases/download/wasm_cal_fdw_v0.1.0/cal_fdw.wasm',
    fdw_package_name 'indobase:cal-fdw',
...
Oops, it looks like we haven't booked any meetings with anybody yet. Now it's the fun part, let's make a booking on [Cal.com](http://Cal.com) from IndoBase!

### Make a bookings on Cal.com from IndoBase
