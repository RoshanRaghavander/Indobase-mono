---
title: 'X / Twitter OAuth 2.0 is now available for IndoBase Auth'
description: 'You can now add "Sign in with X" to your application using the new X / Twitter (OAuth 2.0) provider in IndoBase Auth.'
author: fady
...
You can now add "Sign in with X" to your application using the new **X / Twitter (OAuth 2.0)** provider in IndoBase Auth.
...
3. Add your callback URL from the IndoBase dashboard
4. Copy your **Client ID** and **Client Secret** from the "Keys and tokens" section
5. Enter these credentials in **Authentication > Providers > X / Twitter (OAuth 2.0)** in the IndoBase dashboard

Once configured, you can use the IndoBase client libraries to authenticate users via X / Twitter:
