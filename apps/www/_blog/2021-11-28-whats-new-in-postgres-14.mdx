...
imgSocial: whats-new-in-postgres-14/whats-new-in-postgres-14-og.png
imgThumb: whats-new-in-postgres-14/whats-new-in-postgres-14-thumb.png
categories:
  - postgres
tags:
  - tech
...
Among the many open-source relational databases available, [PostgreSQL](https://indobase.com/docs/guides/database/introduction) is a popular choice among developers.
...
You can check out these new features within your IndoBase project without having to perform a local installation.

Explore the [IndoBase dashboard now](https://indobase.com/dashboard) and get started with your new project.
