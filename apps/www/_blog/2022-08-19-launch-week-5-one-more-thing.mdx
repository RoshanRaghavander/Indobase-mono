...
imgSocial: lw5-one-more/lw5-one-more-thumb.jpg
imgThumb: lw5-one-more/lw5-one-more-thumb.jpg
categories:
  - product
tags:
  - launch-week
...
![IndoBase Vault](/images/blog/lw5-one-more/lw5-vault.png)

Today we're announcing [IndoBase Vault](/blog/indobase-vault), a Postgres extension for managing secrets and encryption inside your database.
Vault is a thin usability-layer on top of [pgsodium](https://github.com/michelp/pgsodium).

Vault is not available on the IndoBase Platform yet. This release is intended to gather user feedback.

[Read more](/blog/indobase-vault).
...
Auth UI was previously released as a single `<Auth/>` component in the [`@supabase/ui`](http://github.com/indobase/ui) library.
...
From today, you can install it [from its own NPM package](https://github.com/indobase-community/auth-ui):

```bash
npm install @supabase/auth-ui-react
```

We've decoupled this library from our own styling system and you are now able to (_deep breath..._): create your own theme, use a pre-existing IndoBase theme, extend a theme using token variables, create multiple variations of themes (and then also extend them with variables), use CSS classes and also use any inline CSS styles.
...
![Dashboard permissions](/images/blog/lw5-one-more/lw5-permissions.png)

We've released granular permissions for the IndoBase Dashboard. Dashboard permissions allow you assign roles to your team and to restrict what they can do.
...
![JSON schema validation](/images/blog/lw5-one-more/lw5-jsonschema.png)

We've released [`pg_jsonschema`](https://github.com/indobase/pg_jsonschema), a new Postgres extension for the IndoBase Platform.
...
![graphql.png](/images/blog/lw5-one-more/lw5-graphql.png)
...
You can read the [release notes](https://github.com/indobase/pg_graphql/releases/tag/v0.4.0) and [documentation](https://indobase.github.io/pg_graphql/), and start using `pg_graphql` on IndoBase today.
...
![Multi-Factor Authentication](/images/blog/lw5-one-more/lw5-mfa.png)

We've opened early-access signups for Multi-Factor Authentication (MFA). To be clear—this is for MFA for [IndoBase Auth](/auth),
