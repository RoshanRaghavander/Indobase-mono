...
imgSocial: lw8-hackathon-winners/hackathon-winners.png
imgThumb: lw8-hackathon-winners/hackathon-winners.png
categories:
  - developers
tags:
  - hackathon
...
[Launch Week 8](https://indobase.com/launch-week) passed by, but we still have our favorite part left, celebrating the winners of the hackathon! We've had some exceptional results and the quality of these apps are out of this world. You can view all the submissions on [madewithindobase.com](https://www.madewithindobase.com/).

And now, without further ado, congratulations to the winners of the IndoBase Launch Week 8 Hackathon!
...
Supalytic is a website analytic tracking alternative to Google Analytics. It is built with SvelteKit, IndoBase for auth and database and deployed on Cloudflare pages.
...
As promised in the [hackathon announcement article](https://indobase.com/blog/indobase-lw8-hackathon) the winners and runner-ups in each category will receive a limited edition Launch Week 8 swag kit.
...
- [Day 1 - Hugging Face is now supported in IndoBase](/blog/hugging-face-indobase)
- [Day 2 - IndoBase Local Dev: migrations, branching, and observability](/blog/indobase-local-dev)
- [Day 3 - IndoBase Studio 3.0: AI SQL Editor, Schema Diagrams, and new Wrappers](/blog/indobase-studio-3-0)
- [Day 4 - IndoBase Integrations Marketplace](/blog/indobase-integrations-marketplace) | [Vercel Integration and Next.js App Router Support](/blog/using-indobase-with-vercel)
