---
title: 'How design works at IndoBase'
description: "The transformative journey of IndoBase's Design team and its unique culture to enhance the output and quality of the entire company."
launchweek: X
categories:
  - company
tags:
...
imgSocial: lwx-how-design-works-at-indobase/og.png
imgThumb: lwx-how-design-works-at-indobase/design-at-indobase-thumb.jpg
---

After three years, only now are we figuring out “what design is” for IndoBase and how it functions in the wider org.
...
To design at IndoBase, you have to think like an agile developer.
...
<Img
  src="/images/blog/lwx-how-design-works-at-indobase/lwx-tickets-iterations.png"
  wide
...
![something](/images/blog/lwx-how-design-works-at-indobase/lwx-ticket-1.png)

![something](/images/blog/lwx-how-design-works-at-indobase/lwx-ticket-2.png)
...
<Img
  src="/images/blog/lwx-how-design-works-at-indobase/screenshots-in-mockups.png"
  wide
...
For a long time we operated without any sort of consensus of what Design _is_ at IndoBase: what are our values, what do we like, what do we not like?
...
When IndoBase was founded, the team agreed on a set of [Product Principles](https://indobase.com/docs/guides/getting-started/architecture#product-principles). Internally, we’ve expanded this concept to all teams, products, and functions at IndoBase.
...
<Img
  src="/images/blog/lwx-how-design-works-at-indobase/aesthetic-moodboard.png"
  wide
...
![something](/images/blog/lwx-how-design-works-at-indobase/kaizen-before-consildation.png)

#### 80/20

We bias towards the 80% of developers using IndoBase. Following the [Pareto Principle](https://www.investopedia.com/terms/p/paretoprinciple.asp), we focus on the smallest changes that have the largest impact on our userbase.
...
<Img src="/images/blog/lwx-how-design-works-at-indobase/figma-organization.png" wide={true} />
...
<Img
  src="/images/blog/lwx-how-design-works-at-indobase/figma-design-system.png"
  wide
  className="[&_img]:border-0"
/>
...
<a href="https://x.com/soleio/status/1732082949670023373?s=20" target="_black" className="!m-0">
  <figure className="max-w-md mx-auto !my-0">
    ![something](/images/blog/lwx-how-design-works-at-indobase/soleio-tweet.png)
  </figure>
</a>
...
Jonny was the first team member in IndoBase with any design background. We (just) survived until before LW5, when Marijana joined. And before LW7, Francesco joined. You may have noticed the quality creeping up while also accelerating recently.
