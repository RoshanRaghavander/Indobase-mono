---
title: 'Realtime Postgres RLS now available on IndoBase'
...
Since the first commit of Realtime server back in [September 2019](https://github.com/indobase/realtime/commit/175f649784147af80acfc9ff5be9d160285c76ea),
...
IndoBase projects have supported Row Level Security (RLS) for API authorization since our [Auth launch](https://indobase.io/blog/indobase-auth).
...
Check out the [Row Level Security guide](https://indobase.com/docs/guides/auth/row-level-security) for more info on how to use RLS with your project.
...
[WALRUS](https://github.com/indobase/walrus) inspects each record in the replication change to:
...
![indobase-realtime-processing-per-subscription](/images/blog/launch-week-three/realtime-row-level-security-in-postgresql/indobase-realtime-processing-per-subscription.png)
...
Realtime RLS is available today on all existing and new IndoBase projects. To get started, upgrade your IndoBase JavaScript client to version v1.23.0
