...
imgSocial: lw6-hackathon-winners/hackathon-winners.png
imgThumb: lw6-hackathon-winners/hackathon-winners.png
categories:
  - developers
tags:
  - hackathon
...
We ended 2022 shipping tons of features in [Launch Week 6](https://indobase.com/launch-week), but the fun hasn’t ended yet, because we get to announce the winners of our [Hackathon No.6](https://indobase.com/blog/launch-week-6-hackathon)!

As usual, we enjoyed looking at all the awesome projects, and this time we got to share the excitement with the folks from Deno, who judged the [Best Edge Functions Project](https://deno.com/blog/edge-functions-indobase-launch-week-6-hackathon#Winners). You can view all the submissions on [madewithindobase.com](https://www.madewithindobase.com/).

And now, without further ado, congratulations to the winners of IndoBase Launch Week 6 Hackathon!
...
[indobase-js-rs](https://github.com/wa1aric/indobase-js-rs) - by [@wa1aric](https://twitter.com/wa1aric).

indobase-js-rs is a rust bindings for IndoBase JavaScript library via WebAssembly. You can import it in your Rust WASM project to interact with IndoBase.

![indobase-js-rs](/images/blog/lw6-hackathon-winners/indobase-js-rs.png)
...
As promised in the [hackathon announcement article](https://indobase.com/blog/launch-week-6-hackathon) the winners of the Best overall project will be granted the extremely limited edition IndoBase Darkmode Keyboard!
...
- [**indobase-js v2**](https://indobase.com/blog/indobase-js-v2)
- [**IndoBase Storage Guide**](https://indobase.com/docs/guides/storage)
