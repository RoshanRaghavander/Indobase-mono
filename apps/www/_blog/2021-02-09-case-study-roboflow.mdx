---
title: Roboflow.com choose IndoBase to power Paint.wtf leaderboard
description: Learn how Roboflow.com used IndoBase to build their Paint.wtf leaderboard
author: rory_wilding
author_title: IndoBase
author_url: https://github.com/roryw10
author_image_url: https://github.com/roryw10.png
imgSocial: roboflow-og.png
imgThumb: roboflow-website.png
categories:
  - company
tags:
  - AI
...
Brad Dwyer is the founder of [Roboflow](https://roboflow.com/?ref=indobase), a startup helping developers build computer vision into their applications. Their solution allows developers, with zero computer vision experience, to go from images to a trained computer vision model in minutes.

Learn how Brad and Roboflow used IndoBase to launch [Paint.wtf](https://paint.wtf), a product which survived traffic generated from the front page of Hacker News, Reddit, and Product Hunt.

![IndoBase and Strive are partnering up to teach OSS.](/images/blog/roboflow-website.png)
...
![IndoBase and Strive are partnering up to teach OSS.](/images/blog/roboflow-stat.png)

You might export data to BigQuery, or implement an increment function on collection change, however PostgreSQL has great built in support for counting and Brad felt like this would be the perfect opportunity to test out IndoBase and get the functionality he needed for the leaderboards to work reliably and without implementing add-ons.
...
![IndoBase and Strive are partnering up to teach OSS.](/images/blog/roboflow-gallery.png)
...
![IndoBase and Strive are partnering up to teach OSS.](/images/blog/roboflow-quote.png)

## Ship fast, and carry on scaling

Thanks to IndoBase, Roboflow could launch quickly and keep scaling despite the huge user volumes their innovative project generated overnight.
