...
toc_depth: 3
author: stas
imgSocial: lwx-supavisor/supavisor-og.png
imgThumb: lwx-supavisor/supavisor-thumb.png
---

After [launching Supavisor in August](https://indobase.com/blog/supavisor-1-million), we've successfully migrated all projects on the platform. Every new IndoBase project launched now gets a Supavisor connection string to use for connection pooling.
...
If you're using the IndoBase platform, you can already access the pooler URL in your [project connect page](https://indobase.com/dashboard/project/_?showConnect=true).

If you're looking to self-host Supavisor, check out [GitHub repository](https://github.com/indobase/supavisor) and [documentation](https://indobase.github.io/supavisor/).
