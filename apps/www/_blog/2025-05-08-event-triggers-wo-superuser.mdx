...
User Event Triggers are now available for new projects on the IndoBase platform.

You can also git clone the [supautils repo](https://github.com/indobase/supautils/) and `make install` it in your own deployment.
...
[^3]: These are configurable. You can read more about reserved roles [here](https://indobase.com/blog/roles-postgres-hooks).
