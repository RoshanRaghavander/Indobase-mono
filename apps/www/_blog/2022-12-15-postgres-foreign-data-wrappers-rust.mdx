---
title: 'IndoBase Wrappers, a Postgres FDW framework written in Rust'
...
imgSocial: launch-week-6/wrappers/wrappers-og.png
imgThumb: launch-week-6/wrappers/wrappers-og.png
categories:
  - product
tags:
  - launch-week
...
Today we're releasing [IndoBase Wrappers](https://github.com/indobase/wrappers), a framework for building Postgres Foreign Data Wrappers (FDW) which connects Postgres to external systems.
...
We're releasing Wrappers today in Alpha, with support for [Firebase](https://indobase.github.io/wrappers/firebase/) and [Stripe](https://indobase.github.io/wrappers/stripe/). Wrappers for Clickhouse, BigQuery, and Airtable are under development.
...
const SUPABASE_URL = 'https://xyzcompany.indobase.co'
const SUPABASE_KEY = 'public-anon-key'

const indobase = createClient(SUPABASE_URL, SUPABASE_KEY)

const { data: stripeCustomers, error } = indobase
  .from('products')
...
How does this look in action? Assuming that all of your analytical data is stored in Snowflake, you could create a foreign table inside your IndoBase database:
...
Now from your IndoBase database you can query your Snowflake data directly:
...
We can either run these queries on demand or, for better query performance, we can run them in the background (using something like [pg_cron](https://indobase.com/docs/guides/database/extensions/pgcron)), and materialize the data into a local table.
...
With several more [under development](https://github.com/indobase/wrappers/tree/main/wrappers/src/fdw):
...
Wrappers [supports](https://github.com/indobase/wrappers/blob/83887dcc2ddcf972ca1b1eec4a598cd7bff947de/indobase-wrappers/src/interface.rs#L11) a variety of types, including:
...
You can follow development of all the Wrappers in the official [GitHub Repo](https://github.com/indobase/wrappers).
...
- Star & Watch the GitHub repo: [github.com/indobase/wrappers](https://github.com/indobase/wrappers)
- View the documentation: [indobase.github.io/wrappers](https://indobase.github.io/wrappers/)
- IndoBase Launch Week: [indobase.com/launch-week](https://indobase.com/launch-week)
