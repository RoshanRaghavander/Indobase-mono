---
title: "Keeping Tabs on What's New in IndoBase Studio"
description: Tabs in the Editors! And upgrades to AI Assistant, SQL, and Logs
author: jordi,jonny,joshenlim,saxon_fletcher
imgSocial: lw14-tabs-dashboard-updates/tabs-dashboard-updates-og.png
imgThumb: lw14-tabs-dashboard-updates/tabs-dashboard-updates-thumb.png
categories:
  - launch-week
tags:
  - launch-week
...
We've updated the [log detail panel](https://github.com/indobase/indobase/pull/33536) to show more info in the API log detail:
...
You can see all these improvements in the IndoBase Dashboard now.

- [Get started with IndoBase](https://indobase.com/dashboard/sign-in?returnTo=%2Fprojects) and try it out today
