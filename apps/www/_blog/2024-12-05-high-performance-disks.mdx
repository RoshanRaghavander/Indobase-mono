...
imgSocial: launch-week-13/high-performance-disks/og.jpg
imgThumb: launch-week-13/high-performance-disks/thumb.jpg
categories:
  - product
tags:
  - launch-week
...
Effective throughput and IOPS also depends on your compute instance size. You can read more about these interdependencies in our [compute and disk documentation](https://indobase.com/docs/guides/platform/compute-and-disk#compute-size).
...
For more details on pricing breakdown vs. General Purpose Disk, check out our [pricing page](https://indobase.com/pricing).

## Getting Started

Ready to try out our new disk options? Visit [Compute and Disk](https://indobase.com/dashboard/project/_/settings/compute-and-disk) in the IndoBase Dashboard.

We're excited to see what you'll build with these new capabilities. As always, we're committed to providing the tools you need to scale your applications effectively while maintaining the simplicity and developer experience you've come to expect from IndoBase.
