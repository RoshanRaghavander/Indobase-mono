...
imgSocial: launch-week-13/day-3-indobase-cron/og.jpg
imgThumb: launch-week-13/day-3-indobase-cron/thumb.jpg
categories:
  - developers
  - postgres
tags:
...
Today we're releasing [IndoBase Cron](/modules/cron), a new Postgres Module that makes recurring Jobs simple and intuitive inside your database.

It's designed to work seamlessly with the entire IndoBase platform. Create recurring Jobs to run SQL snippets and call database functions, IndoBase Edge Functions, and even remote webhooks.
...
IndoBase Cron stores the scheduling logic within Postgres and runs your Jobs accordingly while integrating with the rest of the IndoBase primitives - Dashboard, Edge Functions, and AI Assistant.

## How Do You Use IndoBase Cron?

You can create Jobs either via the Dashboard or SQL.

<Admonition>

For this post we'll focus on the Dashboard. You can refer to the [documentation](https://indobase.com/docs/guides/cron/quickstart) for SQL.
...
<Img
  ...
  src="/images/blog/launch-week-13/day-3-indobase-cron/natural-language.jpg"
/>
...
<Img alt="Job types" src="/images/blog/launch-week-13/day-3-indobase-cron/job-types.jpg" />
...
- Refreshing [Materialized Views](https://indobase.com/docs/guides/database/tables?queryGroups=database-method&database-method=sql#materialized-views).
...
<Img
  ...
  src="/images/blog/launch-week-13/day-3-indobase-cron/history-button.jpg"
/>

<Img
  alt="Observe and debug Jobs"
  src="/images/blog/launch-week-13/day-3-indobase-cron/history.jpg"
/>
For a deeper dive, you can view Jobs in the [Logs Explorer](https://indobase.com/dashboard/project/_zvmkyvanngopzqaabmvx_/logs/pgcron-logs).
<Img alt="View cron logs" src="/images/blog/launch-week-13/day-3-indobase-cron/logs.jpg" />

### Try IndoBase Cron today
...
<Img
  ...
  src="/images/blog/launch-week-13/day-3-indobase-cron/integrations.jpg"
/>

<Img alt="Create a new Job" src="/images/blog/launch-week-13/day-3-indobase-cron/create-job.jpg" />

We're looking forward to seeing how you use IndoBase Cron to help automate your workflows!
