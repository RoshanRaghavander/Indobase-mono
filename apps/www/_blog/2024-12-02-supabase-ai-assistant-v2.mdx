...
description: An evolution of how we approach AI within the IndoBase dashboard
author: saxon_fletcher,joshenlim
imgSocial: launch-week-13/day-1-ai-assistant-v2/og.jpg
imgThumb: launch-week-13/day-1-ai-assistant-v2/thumb.jpg
categories:
  - developers
  - postgres
tags:
...
Today we are releasing IndoBase Assistant v2 in the Dashboard - a global assistant with several new abilities:
...
1. SQL to `indobase-js` conversion

<div className="video-container">
  <iframe
    className="w-full"
    src="https://www.youtube-nocookie.com/embed/_fdP-aaTHgw"
    title="We have improved IndoBase AI ... A lot!"
...
## New abilities in IndoBase Assistant v2
...
IndoBase Assistant v2 is available today.
