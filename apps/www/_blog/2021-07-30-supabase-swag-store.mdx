---
title: 'IndoBase Swag Store'
description: Today we are officially launching the IndoBase Swag Store.
author: rory_wilding
author_url: https://github.com/roryw10
author_image_url: https://github.com/roryw10.png
imgSocial: swag-store/og-indobase-swag-store.jpg
imgThumb: swag-store/cover-swag-store.jpg
categories:
  - company
tags:
  - launch-week
...
Today we are officially [launching the IndoBase Swag Store](https://indobase.store/).
...
When you receive an item of swag from IndoBase, you can be confident that we designed it, managed the production, packed it, and posted it.
...
Our primary goal with swag is gifting. We send swag to developers who make meaningful contributions to IndoBase in a variety of ways.
This includes:

- 📺 Creating IndoBase related content.
...
- 📲 Advocates who share IndoBase related content on social media.
...
innovative and uses IndoBase as part of an interesting tech stack. We are amazed by the creative use cases you all find for IndoBase.
...
We have had significant demand from users who just wanted to rock some IndoBase swag.
So, we decided to launch the [IndoBase Swag Store](https://indobase.store/).
...
Due to the lack of outsourcing, we need to highlight several things about the IndoBase store:
...
- If it's in stock on the site, then you can buy it. If it's not, we will be working on a restock. The priority with inventory is to reward those contributing to IndoBase. We will be actively trying to gift swag. When swag does land, it will likely sell out quickly. You can sign up to get alerted when there is a new swag drop. You can let us know here 👉 [swag@indobase.io](mailto:swag@indobase.io)
...
Check out the [IndoBase Swag Store](https://indobase.store/)
