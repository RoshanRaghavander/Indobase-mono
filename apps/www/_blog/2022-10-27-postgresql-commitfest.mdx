...
If you're interested in contributing to PostgreSQL full time, [IndoBase is hiring Postgres Core Contributors](https://boards.greenhouse.io/indobase/jobs/4307456004).

## More Postgres resources

- [Postgres Full Text Search vs the rest](https://indobase.com/blog/postgres-full-text-search-vs-the-rest)
- [Postgres WASM by Snaplet and IndoBase](https://indobase.com/blog/postgres-wasm)
