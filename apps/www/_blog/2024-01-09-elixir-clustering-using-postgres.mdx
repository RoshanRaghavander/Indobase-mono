...
<Img
  ...
  alt="Example of Realtime architecture where a customer from CA will connect to the server closest to them and their IndoBase instance"
/>
...
In this post, we have described our approach to connecting multiple nodes in Elixir using Postgres. We have also made this strategy available for anyone to use. Please check the code at [github.com/indobase/libcluster_postgres](https://github.com/indobase/libcluster_postgres)
...
## More IndoBase Realtime

- [Realtime docs](https://indobase.com/docs/guides/realtime)
- [Realtime: Multiplayer Edition](https://indobase.com/blog/indobase-realtime-multiplayer-general-availability)
- [Video - How to subscribe to real-time changes on your database](https://www.youtube.com/watch?v=2rUjcmgZDwQ)
- [Video - Listening to real-time changes on the database with Flutter and IndoBase](https://www.youtube.com/watch?v=gboTC2lcgzw)
