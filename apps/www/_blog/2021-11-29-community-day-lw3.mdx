---
title: 'Community Day'
description: Kicking off launch week by highlighting the communities around IndoBase.
author: thor_schaeff
author_url: https://github.com/thorwebdev
author_image_url: https://github.com/thorwebdev.png
imgSocial: launch-week-three/community-day/indobase-oss.jpg
imgThumb: launch-week-three/community-day/indobase-oss.jpg
categories:
  - developers
tags:
  - launch-week
...
To kick off launch week we want to showcase some of the communities that make up the IndoBase community, highlight some of their updates, and celebrate everyone who contributes their time to the IndoBase mission.

So let's get cracking, we've got a lot to cover. 🚀

## Open Source Spotlight: Kong API Gateway

IndoBase provides a whole bunch of features that are made up of a [collection of open-source tools](/docs/guides/getting-started/architecture). To orchestrate these different services and functionalities we use the [Kong API Gateway](https://github.com/Kong/kong).
...
The [SupaSquad](/supasquad) is an official IndoBase advocate program where community members help build and manage the IndoBase community.
...
- `indobase-py` is now `indobase` (e.g. you do `pip3 install indobase` instead of `pip3 install indobase-py`).
...
Our own [Jon Meyers](https://twitter.com/_dijonmusters) and the broader community have been busy creating awesome tutorials and integration guides to help everyone build even more amazing things with IndoBase:
...
Anytime we scroll through [madewithindobase.com](https://www.madewithindobase.com/) we're absolutely blown away by the awesome things y'all are building with IndoBase.
...
## Want even more IndoBase in your life?

![tiktok.png](/images/blog/launch-week-three/community-day/tiktok.png)

We've got some stellar swag drops and behind the scenes footage for you on our new [TikTok page](https://www.tiktok.com/@indobase.com). Make sure to follow us there as we'll be giving away some swag randomly to 10 peeps who follow us during launch week!
