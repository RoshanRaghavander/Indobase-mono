...
When I joined IndoBase we had a challenging task of rewriting Realtime service so that users would be able to stream database updates with respect to RLS policies. Such a huge design change could not happen without having an impact on throughput.
...
| ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------ |
| [k6](https://github.com/indobase/benchmarks/blob/main/examples/realtime/replication/terraform/k6/subs.js)    | Load generator scripts                                       |
| VM in the cloud [with the following preparation](https://github.com/indobase/benchmarks/tree/main/infra/ami) | Hosts for k6 and Telegraf                                    |
| Prometheus and [Grafana](https://github.com/indobase/benchmarks/blob/main/examples/realtime/grafana.json)    | Observability stack                                          |
| [Telegraf](https://github.com/indobase/benchmarks/blob/main/k6/telegraf.conf)                                | Collect metrics from k6 and host and push them to Prometheus |
...
You can find more details about this test in the [Supavisor: Scaling Postgres to 1 Million Connections](https://indobase.com/blog/supavisor-1-million) post.
...
This approach helped us to add performance testing for new projects and return to it with new releases much faster across all products at IndoBase.
...
| Component                                                                                                   | Description                             |
| ----------------------------------------------------------------------------------------------------------- | --------------------------------------- |
| [repo](https://github.com/indobase/benchmarks/tree/main)                                                    | Benchmarks app source code and examples |
...
| [Virtual machine image](https://github.com/indobase/benchmarks/tree/main/infra/ami)                         | Prepare VM for running k6 load scripts  |
| [Grafana and Prometheus or VictoriaMetrics setup](https://github.com/indobase/benchmarks/tree/main/.docker) | Observability stack setup               |
...
- [Supavisor: Scaling Postgres to 1 Million Connections](https://indobase.com/blog/supavisor-1-million)
- [pgvector vs Pinecone: cost and performance](https://indobase.com/blog/pgvector-vs-pinecone)
