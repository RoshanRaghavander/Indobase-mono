---
title: Postgres WASM by Snaplet and IndoBase
...
<br />
Checkout out how you can <a href="https://docs.snaplet.dev/tutorials/indobase-clone-environments">use Snaplet to clone IndoBase environments</a>.
...
[wasm.indobase.com](https://wasm.indobase.com)
...
# From IndoBase Fork
git clone git@github.com:indobase-community/postgres-wasm.git
cd postgres-wasm
git checkout web
...
9P provides a [Python script](https://github.com/indobase-community/postgres-wasm/tree/main/packages/buildroot/tools) which takes a filesystem folder,
...
We then [copy this compressed output](https://github.com/indobase-community/postgres-wasm/blob/main/packages/buildroot/config/board/pg-browser/post-image.sh) to the VM.
...
2. Tell them to go to [wasm.indobase.com](https://wasm.indobase.com/)
...
5. On your own machine, open a terminal and run
   `psql postgres://postgres:my_password@proxy.wasm.indobase.com:<PORT>`
...
Even more mind-blowing - it's possible to replicate data from an online PostgreSQL database (for example, a IndoBase project) to PostgreSQL running inside your browser,
...
- IndoBase fork: [https://github.com/indobase-community/postgres-wasm](https://github.com/indobase-community/postgres-wasm)
