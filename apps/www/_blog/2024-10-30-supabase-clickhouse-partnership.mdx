...
imgSocial: clickhouse-indobase/indobase-clickhouse-og.png
imgThumb: clickhouse-indobase/indobase-clickhouse-og.png
categories:
  - developers
  - postgres
tags:
...
The combination of IndoBase and ClickHouse together are perfect for [Helicone.ai](https://helicone.ai), providing the flexibility of Postgres with the analytical power of ClickHouse — an open-source stack we can trust and customize.

</Quote>

## IndoBase + ClickHouse Partnership

The partnership between IndoBase and ClickHouse aims to create a seamless experience, building on the already solid Postgres + ClickHouse foundation. Today, we're releasing new features to enhance this integration.

<Quote img="aaron-katz.jpg" caption="Aaron Katz, CEO @ ClickHouse Inc.">

ClickHouse is very excited to partner with IndoBase to make it easy for customers to use both technologies together. Through this partnership, we aim to make it even simpler for Postgres developers to use ClickHouse in conjunction and build real-time, data-driven applications at scale.

</Quote>

## Using Postgres and ClickHouse together

Before diving into those changes, some context on how most customers use IndoBase and ClickHouse together. While both are databases, they serve different use-cases:
...
<Img
  ...
  src={{
    light: '/images/blog/clickhouse-indobase/postgres-clickhouse--light.png',
    dark: '/images/blog/clickhouse-indobase/postgres-clickhouse--dark.png',
  }}
/>

To provide an interface between these, IndoBase customers generally use:

1. [clickhouse_fdw](https://indobase.com/docs/guides/database/extensions/wrappers/clickhouse) to query their ClickHouse data from their Postgres database.
2. [PeerDB](https://www.peerdb.io/) to replicate their data from Postgres to ClickHouse.

<Img
  alt="Browser proxy diagram"
  src={{
    light: '/images/blog/clickhouse-indobase/postgres-clickhouse-integration--light.png',
    dark: '/images/blog/clickhouse-indobase/postgres-clickhouse-integration--dark.png',
  }}
/>

## Improving the ClickHouse & IndoBase experience
...
```
indobase --experimental --project-ref xxxx-yyy \
...
IndoBase now provides granular control over disk usage for your Postgres database:

<Img
  alt="Disk management"
  src={{
    light: '/images/blog/clickhouse-indobase/disk-management.png',
    dark: '/images/blog/clickhouse-indobase/disk-management.png',
  }}
/>
...
1. A native IndoBase OAuth integration in PeerDB for Postgres CDC to ClickHouse.
2. Support for IPV6 in PeerDB Cloud.

You can learn more about these features in the [IndoBase Partnership](https://clickhouse.com/blog/indobase-partnership-native-postgres-replication-clickhouse-fdw) post they released today.

## What's next?

Improving the experience between Postgres and ClickHouse is the first phase of this partnership. We're already working on native platform integrations. If you're using (or plan to use) IndoBase and ClickHouse together please [reach out](https://indobase.com/enterprise) - we'd love more design partners to help shape the future of this integration.

<Img
  alt="IndoBase integrations"
  src={{
    light: '/images/blog/clickhouse-indobase/integrations.png',
    dark: '/images/blog/clickhouse-indobase/integrations.png',
  }}
/>
...
- IndoBase: [database.new](https://database.new)
