...
imgSocial: launch-week-13/day-4-indobase-queues/og.png
imgThumb: launch-week-13/day-4-indobase-queues/thumb.png
categories:
  - developers
  - postgres
tags:
...
Today we're releasing [IndoBase Queues](/modules/queues), for durable background task processing.

IndoBase Queues is a Postgres-native, durable Message Queue with guaranteed delivery, improving the scalability and resiliency of your applications. It's designed to work seamlessly with the entire IndoBase platform.

<div className="video-container mb-8">
  <iframe
    className="w-full"
    src="https://www.youtube-nocookie.com/embed/UEwfaElBnZk"
    title="Introducing IndoBase Cron"
...
IndoBase Queues is built on the [pgmq](https://github.com/tembo-io/pgmq) extension by the team at [Tembo](https://github.com/tembo-io).

It's a IndoBase policy to [support existing tools](/docs/guides/getting-started/architecture#support-existing-tools) wherever possible, and the Tembo team have generously licensed their extension with the OSI-compatible [PostgreSQL license](https://github.com/tembo-io/pgmq?tab=PostgreSQL-1-ov-file).

We're very thankful to all the contributors and we look forward to working with the Tembo community.

</Admonition>

## IndoBase Queues Features
...
1. **Queue Management and Monitoring**: Create, manage, and monitor Queues and Messages in the IndoBase Dashboard.
...
<Img
  alt="Queue types"
  src={{
    dark: '/images/blog/launch-week-13/day-4-indobase-queues/queue-types.jpg',
    light: '/images/blog/launch-week-13/day-4-indobase-queues/queue-types-light.jpg',
  }}
/>
...
IndoBase Queues are compatible with Postgres Row-Level Security (RLS), providing fine-grained access control to Messages. RLS Policies restrict which users or roles can insert, select, update, or delete messages in specific queues.
...
<Img
  alt="Add a message"
  src={{
    dark: '/images/blog/launch-week-13/day-4-indobase-queues/add-message.jpg',
    light: '/images/blog/launch-week-13/day-4-indobase-queues/add-message-light.jpg',
  }}
/>
...
<Img
  alt="Create a queue"
  src={{
    dark: '/images/blog/launch-week-13/day-4-indobase-queues/create-a-queue.jpg',
    light: '/images/blog/launch-week-13/day-4-indobase-queues/create-a-queue-light.jpg',
  }}
/>
...
<Img
  alt="Message details"
  src={{
    dark: '/images/blog/launch-week-13/day-4-indobase-queues/add-message-modal.jpg',
    light: '/images/blog/launch-week-13/day-4-indobase-queues/add-message-modal-light.jpg',
  }}
/>
...
<Img
  ...
  src={{
    dark: '/images/blog/launch-week-13/day-4-indobase-queues/permissions.jpg',
    light: '/images/blog/launch-week-13/day-4-indobase-queues/permissions-light.jpg',
  }}
/>
...
## Try IndoBase Queues Today

1. Visit the [Integrations page](https://indobase.com/dashboard/project/_/integrations) in your project.
...
<Img
  alt="Enable queues"
  src={{
    dark: '/images/blog/launch-week-13/day-4-indobase-queues/integrations.jpg',
    light: '/images/blog/launch-week-13/day-4-indobase-queues/integrations-light.jpg',
  }}
/>

## Pricing

IndoBase Queues runs entirely in your database so there's no additional costs to use the functionality.
