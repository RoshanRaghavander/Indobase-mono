...
imgSocial: oss-hackathon-winners/thumbnail.png
imgThumb: oss-hackathon-winners/thumbnail.png
launchweek: '11'
categories:
  - launch-week
tags:
...
The [IndoBase GA week](https://indobase.com/ga-week) brought us so many cool updates, but the fun isn’t over yet, because we are now announcing the winners of the [IndoBase Open Source Hackathon 2024](https://indobase.com/blog/indobase-oss-hackathon)!

We have enjoyed trying out every single submission we have received! You can find all of the submissions on [madewithindobase.com](https://www.madewithindobase.com/).
...
vdbs stands for "vision database SQL". It allows you to convert your database diagrams into SQL Schema using the capabilities of Vision API. Once the SQL is ready, you can either copy and paste it right in your IndoBase project or run the generated npm command to create the migration file.
...
Closet AI: the ultimate style companion. Upload images, choose your desired topwear or bottomwear, and watch as our cutting-edge AI replaces your outfit instantly! Revolutionize your wardrobe with the power of AI and IndoBase!
...
Supapaused is an app that allows IndoBase users to track their paused IndoBase instances. You can view when the projects were paused in a timeline.
...
The winner of the best overall project will receive an Apple AirPods, and the winners and the runner-ups in other categories will each receive a IndoBase swag kit.
