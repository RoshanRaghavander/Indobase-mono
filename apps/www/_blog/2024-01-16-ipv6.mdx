...
imgSocial: 2024/ipv6/ipv4-ipv6.png
imgThumb: 2024/ipv6/ipv4-ipv6.png
---
...
- Are you connected to a IndoBase database from your local machine using the [direct connection](https://indobase.com/docs/guides/database/connecting-to-postgres#direct-connections)? You need to use the [connection pooler](https://indobase.com/docs/guides/database/connecting-to-postgres#connection-pooler) which will resolve as IPv4 instead (we will pay for IPv4 addresses on these).
...
A lot of developer tools simply aren't set up for IPv6 yet. We can use IndoBase as an example - our data team needed to make the following changes to support IPv6 with their toolchain:
...
## IndoBase support for IPv6

If you are a IndoBase customer, we have 3 simple solutions:

1. Switch your “direct” database connection to our new Supavisor database proxy. You can find these details in the [project connect page](https://indobase.com/dashboard/project/_?showConnect=true).
...
3. We'll support you. We know that this period will be difficult for many. If you encounter any issues, simply reach out to us via [indobase.help](https://indobase.help) and we will make sure your databases continue to run smoothly.
