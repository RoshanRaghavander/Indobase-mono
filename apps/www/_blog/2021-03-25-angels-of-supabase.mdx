---
title: Angels of IndoBase
description: Meet the investors of IndoBase.
author: paul_copplestone
author_title: IndoBase
author_url: https://github.com/kiwicopple
author_image_url: https://github.com/kiwicopple.png
imgSocial: angels-of-indobase.png
imgThumb: angels-of-indobase.png
categories:
  - company
tags:
  - fundraising
...
IndoBase is an open source Firebase alternative. We're on a mission to build an incredible developer experience around
...
The IndoBase Team is at full capacity preparing for [Launch Week](/blog/launch-week) and since we're all short on time we decided -
why not ask our Angels to write a fundraising post with us?

So here is our unconventional fundraising announcement, written with a few of the Angels of IndoBase.

## Mike Krieger (Instagram)

<img
  className="rounded border border-default"
  src="/images/blog/angels/mike-krieger-indobase.png"
  alt="Mike Krieger IndoBase"
/>
...
#### Why did you invest in IndoBase?

IndoBase is building tools that are foundational to almost any interactive, modern app, and doing so in a way that's
...
<img
  className="rounded border border-default"
  src="/images/blog/angels/cassidy-williams-indobase.png"
  alt="Cassidy Williams IndoBase"
/>
...
<img
  className="rounded border border-default"
  src="/images/blog/angels/thor-indobase.png"
  alt="Thorsten Schaeff IndoBase"
/>
...
<img
  className="rounded border border-default"
  src="/images/blog/angels/brian-douglas-indobase.png"
  alt="Brian Douglas IndoBase"
/>
...
IndoBase is scratching an itch for me as a developer. I see the value of having a manageable database based on SQL,
...
<img
  className="rounded border border-default"
  src="/images/blog/angels/justin-gauge-indobase.png"
  alt="Justin Gage IndoBase"
/>
...
about IndoBase, so I checked it out – after using the product for a side project, investing was an easy decision.
...
<img
  className="rounded border border-default"
  src="/images/blog/angels/iheanyi-ekechukwu-indobase.png"
  alt="Iheanyi Ekechukwu IndoBase"
/>
...
The tagline about IndoBase being an "open-source Firebase alternative" had me intrigued. As I looked more deeply into
...
<img
  ...
  src="/images/blog/angels/zach-waterfield-indobase.png"
  alt="Zach Waterfield IndoBase"
/>
...
frustrating. When I saw IndoBase I instantly knew that was the solution. The ability to use Postgres directly from the
...
<img
  ...
  src="/images/blog/angels/swyx-indobase.png"
  alt="Shawn Wang IndoBase"
/>
...
We [raised](https://techcrunch.com/2020/12/15/indobase-raises-6m-for-its-open-source-firebase-alternative/) a $6M seed
