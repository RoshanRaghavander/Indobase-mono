...
imgSocial: flutter-hackathon-winners/flutter-hackathon-winners.png
imgThumb: flutter-hackathon-winners/flutter-hackathon-winners.png
categories:
  - developers
tags:
  - hackathon
...
[Accident Detection](https://github.com/Guneetsinghtuli/indobase) - by [@Guneetsingh02](https://twitter.com/Guneetsingh02)
...
[@samuelP09301972](https://twitter.com/samuelP09301972), the creator of Syno will receive a limited Flutter-themed IndoBase keyboard.
...
If you missed the hackathon, but still want to build awesome apps using Flutter and IndoBase, here are some resources to get you started:

- [Flutter Quick Start Guide](https://indobase.com/docs/guides/with-flutter)
- [IndoBase Flutter documentation](https://indobase.com/docs/reference/dart/introduction)
- [Edge Functions Guide](https://indobase.com/docs/guides/functions)
- [Setup IndoBase on FlutterFlow guide](https://docs.flutterflow.io/data-and-backend/indobase/indobase-setup)
- [How to Set Up IndoBase Authentication in FlutterFlow video](https://www.youtube.com/watch?v=tL-sLPfWzVE)
