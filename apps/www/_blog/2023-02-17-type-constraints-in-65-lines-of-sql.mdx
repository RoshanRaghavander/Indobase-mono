...
author: oli_rice
imgSocial: 2023-jan/semver-thumb.jpg
imgThumb: 2023-jan/semver-thumb.jpg
categories:
  - postgres
tags:
  - postgres
...
values
    ('indobase-js', (2, 2, 3, null, null)),
    ('indobase-js', (2, 0, 0, array['rc', '1'], null)
);
...
- add convenience functions to parse a [semver type from text](https://github.com/indobase/dbdev/blob/ca338584203d9b2eb7a4a378f5724674c15b9c25/indobase/migrations/20220117141507_semver.sql#L78)
- [override the equality operator](https://github.com/indobase/dbdev/blob/ca338584203d9b2eb7a4a378f5724674c15b9c25/indobase/migrations/20220117141507_semver.sql#L37-L63) (`=`) to correctly reflect that versions differing only in build metadata are considered equal
- [add a `max` function](https://github.com/indobase/dbdev/blob/ca338584203d9b2eb7a4a378f5724674c15b9c25/indobase/migrations/20220117141507_semver.sql#L122-L140) to efficiently query for the newest version of each package from within the database
