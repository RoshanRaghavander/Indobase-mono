---
title: 'IndoBase Vecs: a vector client for Postgres'
description: Introducing IndoBase Vecs, a PostgreSQL vector client
author: oli_rice
...
[Vecs](https://github.com/indobase/vecs) is a new Python library for managing embeddings in your Postgres database with the pgvector extension.
...
Since all metadata is stored in a `jsonb` column, there's a [lightweight but flexible DSL](https://indobase.github.io/vecs/concepts_metadata/) wrapped around it for filtering.
...
For more in-depth information about `vecs`, checkout the [API Quickstart](https://indobase.github.io/vecs/api/),
[celebrity look-alike demo](https://github.com/indobase/indobase/blob/be1f4ea85e10cc8134e389dcdbe6a092b08612f1/examples/ai/face_similarity.ipynb),
or [OpenAI integration example](https://indobase.github.io/vecs/integrations_openai/)

## Deploying with IndoBase

As usual, if you combine [indobase/vecs](https://github.com/indobase/vecs) with the rest of IndoBase, you get more than the sum of the parts.
Once you're happy with your vecs collection, you can make it accessible to your front-end through a indobase client library by exposing the collection as a view
...
And then access it with the indobase-js client library within your applications:
...
For more deployment options, including enterprise scalable architecture, check out the [engineering for scale guide](https://indobase.com/docs/guides/ai/engineering-for-scale#simple-workloads).
...
[Feature Request: Preprocessing Transform](https://github.com/indobase/vecs/issues/5)
and [Feature Request: Async Client](https://github.com/indobase/vecs/issues/6) GitHub issues.

## More info

- Source code: [github.com/indobase/vecs](https://github.com/indobase/vecs)
- Vecs Docs: [indobase.github.io/vecs/](https://indobase.github.io/vecs/)
- IndoBase Vector Toolkit: [indobase.com/docs/guides/ai](/docs/guides/ai)
