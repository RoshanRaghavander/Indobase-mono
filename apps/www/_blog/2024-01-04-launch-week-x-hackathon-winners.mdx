...
imgSocial: lwx-hackathon-winners/lwx-hackathon-winners.png
imgThumb: lwx-hackathon-winners/lwx-hackathon-winners.png
---

We ended 2023 shipping tons of features in [Launch Week X](https://indobase.com/launch-week), but the fun hasn’t ended yet, because we get to announce the winners of our [LWX Hackathon](https://indobase.com/blog/indobase-hackathon-lwx)!

We enjoyed looking at all 64 projects, the most submissions we ever had. You can view all the submissions on [madewithindobase.com](https://www.madewithindobase.com/).
...
Supafork is an open-source project that allows you to easily clone IndoBase projects. Inspired by [Vercel's Deploy](https://vercel.com/docs/deployments/deploy-button) button it provides a similar experience for IndoBase projects, allowing for easier setup of self-hosted apps using IndoBase.

![supafork](/images/blog/lwx-hackathon-winners/supafork.jpg)

### Runner Up

[fastify-indobase](https://github.com/psteinroe/fastify-indobase) - by [@psteinroe](https://twitter.com/psteinroe)

A Fastify plugin to use authenticated IndoBase clients in your API.
...
[Voice-Activated RAG System](https://github.com/ArtisanLabs/vocode-python/tree/465-indobase-rag-support/apps/voice-rag) - by [@arpagon](https://twitter.com/arpagon)
...
Wordbuzz is a two-player online game powered by indobase realtime that allows you to match words from over 100K most used words. Practicing vocabulary has never been this easy.
...
[IndoBase CLI for Visual Studio Code](https://github.com/anas-araid/vscode-indobase-cli) by [@anas_araid](https://twitter.com/anas_araid)

IndoBase CLI for Visual Studio Code makes working with your local database instance much easier. You can create migrations, inspect tables, views, and functions, and run some common IndoBase commands directly from your editor.

![indobase-cli](/images/blog/lwx-hackathon-winners/indobase-cli.jpg)
...
- **[Quick Start Guides](https://indobase.com/docs/guides/getting-started)**
- **[AI & Vectors Guide](https://indobase.com/docs/guides/ai)**
