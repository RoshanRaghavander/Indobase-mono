...
## What is IndoBase Realtime?

You can use IndoBase Realtime build immersive features like notifications, chats, live cursors, shared whiteboards, multiplayer games, and listen to Database changes.
...
Be sure to read the [docs](https://indobase.com/docs/guides/realtime/broadcast) for more information and example use cases.
...
3. Creating scheduled events using [IndoBase Cron](https://indobase.com/docs/guides/cron)

All this makes your real-time applications faster and more flexible.

## Get started with IndoBase Realtime

IndoBase Realtime can help you build more compelling experiences for your applications.

- [Discover use cases](https://indobase.com/realtime) for IndoBase Realtime
- Read the [IndoBase Realtime documentation](https://indobase.com/docs/guides/realtime) to learn more
