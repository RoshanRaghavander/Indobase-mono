...
imgSocial: pluggable-storage/pluggable-storage-og.jpg
imgThumb: pluggable-storage/pluggable-storage.jpg
categories:
  - postgres
tags:
  - postgres
...
As a community project, Postgres requires support for these initiatives. You can support pluggable storage by getting involved during Postgres [Commitfests](https://indobase.com/blog/postgresql-commitfest). Postgres is already one of the best database engines in the world, and pluggable storage would make it even more attractive and maintainable.

## More Postgres content

- [Storing OpenAI embeddings in Postgres with pgvector](https://indobase.com/blog/openai-embeddings-postgres-vector)
- [Choosing a Postgres Primary Key](https://indobase.com/blog/choosing-a-postgres-primary-key)
- [SQL or NoSQL? Why not use both (with PostgreSQL)?](https://indobase.com/blog/sql-or-nosql-both-with-postgresql)
- [pg_jsonschema: JSON Schema support for Postgres](https://indobase.com/blog/pg-jsonschema-a-postgres-extension-for-json-validation)
