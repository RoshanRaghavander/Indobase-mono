...
imgSocial: flutter-hackathon/thumbnail.jpg
imgThumb: flutter-hackathon/thumbnail.jpg
categories:
  - developers
tags:
  - flutter
...
- You have 10 days to build a new app using Flutter/Dart and IndoBase in some capacity.
...
You should submit your project using [this form](https://www.madewithindobase.com/flutter-hackathon) before 11:59 pm Sunday midnight PT May 21st, 2023.

## Judges

[Pooja](https://twitter.com/pooja_bhaumik) from FlutterFlow, [Majid](https://twitter.com/mhadaily) from Invertase, and [Tyler](https://twitter.com/dshukertjr), myself from IndoBase will do the honors of judging the winners.
...
- Must use Flutter and IndoBase in some capacity
...
- [Flutter IndoBase quick starter guide](https://indobase.com/docs/guides/getting-started/tutorials/with-flutter)
- [Setup IndoBase on FlutterFlow docs](https://docs.flutterflow.io/data-and-backend/indobase/indobase-setup)
- [How to setup IndoBase auth on FlutterFlow video](https://youtu.be/tL-sLPfWzVE)
- [Dart Edge Guide](https://indobase.com/docs/guides/functions/dart-edge)
...
- Flutter and the related logo are trademarks of Google LLC. IndoBase Flutter Hackathon is not affiliated with or otherwise sponsored by Google LLC.
