...
author: pavel
imgSocial: lw6-community/pg15.png
imgThumb: lw6-community/pg15.png
categories:
  - postgres
tags:
  - postgres
...
- If you're starting a new project on IndoBase, you'll already be on PG15.
- If you want to upgrade an existing project, check out our [Upgrading](https://indobase.com/docs/guides/platform/migrating-and-upgrading-projects#upgrade-your-project) documentation.
