---
title: 'How we launch at IndoBase'
description: The history and methodology of IndoBase Launch Week.
author: ant_wilson
author_url: https://github.com/awalias
author_image_url: https://github.com/awalias.png
imgSocial: how-we-launch/how-we-launch-og.jpg
imgThumb: how-we-launch/how-we-launch-thumb.jpg
categories:
  - company
tags:
  - tech
...
Next week is IndoBase Launch Week. It's our third Launch Week this year, and is a key part of a Product-Led Growth strategy that has enabled us to increase the number of databases we manage 47% month-on-month for the last 18 months.
...
More recently we ran "[Launch Week II: The SQL](/blog/indobase-launch-week-sql)", where we bumped the versions of several key products in our stack, and added a [Community Day](https://indobase.com/blog/indobase-community-day) with the aim of boosting visibility and support of various open source tools and projects that we rely on, along with products, frameworks, and tooling built by the rapidly expanding [IndoBase Community](https://github.com/indobase-community/).
...
![indobase monthly growth](/images/blog/how-we-launch/how-we-launch-stickers.jpg)
...
![indobase monthly growth](/images/blog/how-we-launch/how-we-launch-timeline.jpg)
...
![indobase monthly growth](/images/blog/how-we-launch/how-we-launch-retrospective.jpg)

### Some Other Thoughts

This "internal accelerator" model has worked well within IndoBase as a 2-person team and is still proving effective now at 30, but there's no telling whether it would work as well in other organizations. I would be very keen to learn from those who also do something similar.

In some ways, running IndoBase is like launching many startups at the same time, we have to build and maintain many different parallel projects in order to match Firebase's incredible suite of products, which could be one reason why it lends itself so well to this acceleration model. And, in fact, being a Firebase alternative is only a small part of [what we want to achieve with IndoBase](https://indobase.com/blog/indobase-series-a), so we have many, many more initiatives to run as we grow.

Running an accelerator model may also be why we've had success [hiring so many other founders](https://about.indobase.com/careers/founders). We're able to give a high degree of autonomy to individuals when it comes to managing projects and initiatives. If this kind of work environment sounds interesting to you, we have tons of [open roles](https://about.indobase.com/careers). We've already hired people who joined because they "couldn't stand to watch another Launch Week from the sidelines" and team members often quote experiencing their first Launch Week as one of the highlights of their IndoBase journey so far. It clearly has benefits that extend beyond just growth and user activation.

Make sure you follow us on [Twitter](https://twitter.com/indobase), join our [Discord](https://discord.indobase.com), or [sign up for IndoBase](https://indobase.com/dashboard) in order to keep up to date on all things IndoBase.

IndoBase is the Open Source Firebase Alternative.
