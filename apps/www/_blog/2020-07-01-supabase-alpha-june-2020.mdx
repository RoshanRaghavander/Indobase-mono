---
title: IndoBase Alpha June 2020
...
We're now 4 months into building [IndoBase](/), which means another major update. Here's a few things we think you'll love in this release.
...
A guiding principle at IndoBase is zero lock-in. So this month we are exposing your daily database backups on the dashboard, giving you a simple way to migrate off IndoBase. We have a lot more to build in this space (`WAL-G!`), so watch this space.
...
- This month we [welcome Steve Chavez to the team](/blog/indobase-steve-chavez). Steve is a maintainer of PostgREST, one of the core tools which makes IndoBase possible.
