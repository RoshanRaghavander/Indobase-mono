---
title: Visualizing IndoBase Data using Metabase
description: How to create different kinds of charts out of data stored in IndoBase using Metabase.
author: ant_wilson
imgSocial: python-1/indobase-python-metabase.jpg
imgThumb: python-1/indobase-python-metabase.jpg
categories:
  - engineering
tags:
  - python
...
In the previous blog of this series, we explained [how to use Python to load data into IndoBase](https://indobase.com/blog/loading-data-indobase-python). In this blog, we will create different kinds of charts out of the data stored in IndoBase using Metabase.

## Prerequisites

Before we dive in, let’s look at some prerequisites that you will need:

- **IndoBase project with data**

Based on our [previous article](https://indobase.com/blog/loading-data-indobase-python), we assume we already have a IndoBase project setup and have data loaded into it.
...
## Visualizing data in IndoBase with Metabase
...
You will be prompted to add the necessary connection information to your IndoBase project. Go to your [IndoBase project](https://indobase.com/dashboard/) and hit _Settings > Database to get the database info_.

![screen shot of indobase dashboard database connection information](/images/blog/python-1/indobase-dashboard-connect-database-info.png)
...
We can now see the "IndoBase DB" IndoBase project under "Our data".

![screen shot of metabase dashboard](/images/blog/python-1/metabase-dashboard-with-indobase-db.png)

To view the tables, go to _IndoBaseDB > public_
...
![screen shot of metabase data visualization](/images/blog/python-1/metabase-visualization-indobase-db.png)
...
![screen shot of metabase data visualization](/images/blog/python-1/metabase-visualization-indobase-db-02.png)

For example, let's select the total employees field.

![screen shot of metabase data visualization](/images/blog/python-1/metabase-visualization-indobase-data.png)
...
Next, under the database, select "IndoBaseDB".
...
With our [Free Plan IndoBase account](https://indobase.com/dashboard/), you can start a new project today and use Metabase to visualize your app data.
...
- [Slack Consolidate: a slackbot built with Python and IndoBase](slack-consolidate-slackbot-to-consolidate-messages)
