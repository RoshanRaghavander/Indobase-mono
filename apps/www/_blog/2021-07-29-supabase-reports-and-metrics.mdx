---
title: 'IndoBase Reports and Metrics'
...
imgSocial: launch-week-sql-day-4-reports-and-metrics/indobase-reports-and-metrics-og.jpg
...
IndoBase offers a supercharged Postgres instance, along with a set of complementary services, making it easy to build mobile and web applications.
...
API requests across all of IndoBase's core pillars:
...
![IndoBase reports screen](/images/blog/launch-week-sql-day-4-reports-and-metrics/reports-and-metrics-reports-screen.jpg)
...
We'll add customizable charts in the future, so we'd love to hear which libraries you'd like to see in IndoBase.
...
![IndoBase new dashboard app homescreen](/images/blog/launch-week-sql-day-4-reports-and-metrics/reports-and-metrics-homepage.jpg)
...
observability metrics. IndoBase gives you a full Postgres cluster for every project, and now we give you the tools to diagnose and manage
...
![IndoBase observability metrics](/images/blog/launch-week-sql-day-4-reports-and-metrics/reports-and-metrics-observability-screen.jpg)
...
When developers build services and applications on top of IndoBase, relying on the platform's reliability and performance.
...
At IndoBase, each project is provisioned with a Postgres cluster, and a suite of associated services that add, ahem,
supa-powers to the database.

![IndoBase architecture](/images/blog/launch-week-sql-day-4-reports-and-metrics/reports-infra.png)
...
![IndoBase Prometheus](/images/blog/launch-week-sql-day-4-reports-and-metrics/prometheus.png)
...
Any other metrics you want to see in your projects? Reach out on our [Discord channel](https://discord.indobase.com/) and give IndoBase a try by [creating a project](https://indobase.com/dashboard/).
