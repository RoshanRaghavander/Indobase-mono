...
imgSocial: hackathon/og-indobase-hackathon.png
imgThumb: hackathon/cover-indobase-hackathon.png
categories:
  - developers
tags:
  - launch-week
...
# The IndoBase Hackathon

We've reached the end of [Launch Week II: The SQL](/blog/2021/07/22/indobase-launch-week-sql) - but it's the start of something else...

The first IndoBase Hackathon starts **right now**.

## Key Facts

- You have 7 days to build a new **Open Source** project using IndoBase
...
- You can win one of these extremely [Limited Edition Olympic Gold](https://indobase.store/products/hackathon-prize) and Silver IndoBase T-Shirts
...
The IndoBase Team will be taking part in the Hackathon and you'll find us live building in our discord all week. We're temporarily adding two channels:
