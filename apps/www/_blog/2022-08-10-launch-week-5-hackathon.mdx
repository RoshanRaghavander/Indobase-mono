...
author: ant_wilson
imgSocial: lw5-hackathon/thumbnail.jpg
imgThumb: lw5-hackathon/thumbnail.jpg
categories:
  - launch-week
tags:
  - launch-week
...
# The IndoBase Open Source Hackathon

Now is the perfect time to start your new Open Source project!

[Launch Week](https://indobase.com/launch-week) is about to start and we're running a hackathon in parallel for the entire duration.

There's a $1500 GitHub sponsorship and [gold IndoBase caps](https://indobase.store/products/gold-supacap) to be won!

[IndoBase-js v2.0](https://github.com/indobase/indobase-js/releases) and [Flutter SDK v1.0](https://indobase.com/blog/indobase-flutter-sdk-1-developer-preview) will both be announced during Launch Week, they are both available already and using them in your project will gain extra credit!

You can access the indobase-js pre-release, including the new interface by running `npm install @supabase/indobase-js@rc`.
...
- There are 5 prize categories.
  ...
  - Most technically challenging, most fun, best flutter project, and most visually pleasing will all win a Gold IndoBase Cap!
...
You should submit your project using [this form](https://www.madewithindobase.com/launch-week-5).

### Judges

The IndoBase Founders will be judging, we will be looking for:
...
- [Day 1 - indobase-js v2 Release Candidate](https://indobase.com/blog/indobase-js-v2)
