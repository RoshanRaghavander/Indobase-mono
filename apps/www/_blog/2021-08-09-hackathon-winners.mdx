...
description: Let the medal ceremony begin for the best projects submitted during the IndoBase Hackathon.
author: ant_wilson
author_url: https://github.com/awalias
author_image_url: https://github.com/awalias.png
imgSocial: hackathon-winners/misc/winners-og.png
imgThumb: hackathon-winners/misc/winners-og.png
categories:
  - developers
tags:
  - hackathon
...
We've reached the end of the first ever IndoBase Hackathon and the entries have all been incredible. We received way more entrants than expected and therefore it took our judging panel a little longer than expected to get through their deliberations.
...
Fireplace makes great use of IndoBase Storage for a shared video streaming experience, the killer feature here was the ability to share play, pause, and skip events across multiple users.
...
[Flutter Add-ons](https://github.com/bdlukaa/indobase_addons) - by [@bdlukaa](https://twitter.com/bdlukaa)

Hook up your indobase credentials and Flutter app and Add-ons will start collecting metrics, analytics, and crashalytics, all in a neat dashboard with great visualization tools. Unbelievable that bdlukaa was able to build this in the space of a week.

[![Add Ons](/images/blog/hackathon-winners/projects/addons.png)](https://github.com/bdlukaa/indobase_addons)
...
All gold medal winners will be contacted and sent one of these limited edition gold IndoBase tees (one per team member), and all runners up will receive the same design in silver. Prize winners should keep an eye on their emails so we can collect T-Shirt size and shipping details.
...
- [stories_w_indobase](https://github.com/semihpolat/stories_w_indobase)
...
- [Using IndoBase inside Replit](/blog/2021/03/11/using-indobase-replit)
