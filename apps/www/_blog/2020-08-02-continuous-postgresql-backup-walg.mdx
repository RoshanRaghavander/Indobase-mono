...
Make sure the below packages are installed in your instances. Alternatively, you can spin up the [latest version](https://github.com/indobase/postgres/releases/tag/v0.13.0) of [IndoBase Postgres](https://github.com/indobase/postgres) which would already have everything configured and installed, along with other [goodies](https://github.com/indobase/postgres#features). It is readily available in either the [AWS](https://aws.amazon.com/marketplace/pp/B08915TCJ2?qid=1595854723755&sr=0-1&ref_=srh_res_product_title) or [Digital Ocean](https://marketplace.digitalocean.com/apps/indobase-postgres) marketplaces and only takes [a few minutes](/docs/postgres/postgres-intro) to get running.
