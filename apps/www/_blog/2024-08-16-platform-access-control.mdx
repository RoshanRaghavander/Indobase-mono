...
description: Granular permissions for adding users to specific projects in an IndoBase organization.
author: hieu,joshenlim
imgSocial: lw12/day-5/OG_platform-access-control.png
imgThumb: lw12/day-5/thumb_platform-access-control.png
launchweek: '12'
categories:
  - launch-week
  - developers
...
At IndoBase, we're constantly striving to provide the tools developers need to build secure, reliable applications. Our latest update focuses on an area that's critical to both security and reliability: Platform Access Control.
...
Managing who can access what within your project isn't just a convenience — it's essential for maintaining security and ensuring that your software development lifecycle (SDLC) is followed and availability guarantees are met. While IndoBase already provides a robust data security framework through Row-Level Security (RLS), we recognized a gap when it came to managing platform-level access. Our new Platform Access Control feature fills that gap by offering Role-Based Access Control (RBAC) to the IndoBase platform and management APIs.

### Granular control at your fingertips

With Platform Access Control, IndoBase now offers a way to manage permissions at the both the organization and project levels.
