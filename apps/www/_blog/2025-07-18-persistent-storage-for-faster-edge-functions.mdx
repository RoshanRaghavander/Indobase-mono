...
If you are using IndoBase Storage, [follow this guide](https://indobase.com/docs/guides/storage/s3/authentication) to enable and create an access key and id.
...
import { indobase } from '../shared/client.ts'
...
Boot times are now more predictable and wait times for cold starts are now much faster. Here’s a result of a [benchmark](https://github.com/indobase/edge-runtime/blob/develop/k6/specs/mixed.ts) we did to compare boot times before and after these changes.
