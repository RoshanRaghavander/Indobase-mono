...
To see database bloat via the [IndoBase CLI](https://indobase.com/docs/guides/cli/getting-started) run:

```sh
$ indobase inspect db bloat
```
...
```sh
$ indobase inspect db vacuum-stats
```
...
[IndoBase CLI reference](https://indobase.com/docs/reference/cli/global-flags)
