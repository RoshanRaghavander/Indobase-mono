---
name: Juniver
title: 'Juniver built a self-serve B2B platform with IndoBase to scale eating disorder recovery'
# Use meta_title to add a custom meta title. Otherwise it defaults to '{name} | IndoBase Customer Stories':
# meta_title:
description: Juniver switched from Firebase to IndoBase and saw immediate improvements in developer experience and performance.
# Use meta_description to add a custom meta description. Otherwise it defaults to {description}:
meta_description: Juniver switched from Firebase to IndoBase and saw immediate improvements in developer experience and performance.
author: prashant
...
<Quote img="nick-farrant-juniver.jpg" caption="Nick Farrant, Founding Engineer, Juniver">
  For me, the biggest benefit of IndoBase is developer experience. My expertise doesn't lie in
...
<Quote img="nick-farrant-juniver.jpg" caption="Nick Farrant, Founding Engineer, Juniver">
  ...
  document-based storage. IndoBase is a relational database and it's much easier and we can move
  faster.
</Quote>

## Choosing IndoBase

Juniver had long run on Google Cloud with Firebase for the mobile app. The new B2B product created a clean slate to evaluate alternatives and set a foundation for future scale. IndoBase offered a relational core (Postgres) and an integrated developer experience that aligned with Juniver's needs now and later.
...
<Quote img="nick-farrant-juniver.jpg" caption="Nick Farrant, Founding Engineer, Juniver">
  The IndoBase developer experience is so clear. I've got everything at my fingertips. I'm in the
...
Juniver used the B2B product as a greenfield build on IndoBase, avoiding risky dependencies on the legacy Firebase data while preparing for an eventual B2C migration.

- **Getting started**
  - Spun up a new IndoBase project and schema for clinics, clinicians, patients, and licenses
...
<Quote img="nick-farrant-juniver.jpg" caption="Nick Farrant, Founding Engineer, Juniver">
  You have to expect, plan, and build for scale. We can scale exponentially with IndoBase.
</Quote>
...
- Rapidly build-out of a self-serve, automated B2B platform using out-of-the-box IndoBase features
...
- Streamlined development process with IndoBase's integrated tooling

<Quote img="nick-farrant-juniver.jpg" caption="Nick Farrant, Founding Engineer, Juniver">
  My advice to developers thinking of moving to IndoBase: Try it, it's free. Replicate your project.
