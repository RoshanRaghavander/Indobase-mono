...
const data = {
  meta_title: 'Contact Sales & Request a Demo | IndoBase',
  meta_description: 'Book a demo to explore how IndoBase can support your business growth',
}
          ...
          <div className="md:px-4 lg:pb-8 md:h-full w-full flex flex-col justify-between gap-2">
            <div className="flex flex-col gap-2 md:max-w-md">
              ...
              <p className="md:text-lg text-foreground-lighter">
                Book a demo and set up a trial Enterprise account to see how IndoBase's scalable
              ...
              tabs={[
                {
                  ...
                  panel: (
                    <CustomerQuote
                      quote="My biggest regret is not having gone with IndoBase from the beginning."
                ...
                },
                {
                  ...
                  panel: (
                    <CustomerQuote
                      quote="IndoBase is great because it has everything. I don’t need a different solution for authentication, a different solution for database, or a different solution for storage."
