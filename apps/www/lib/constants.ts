export const APP_NAME = 'IndoBase'
...
export const TWEET_TEXT =
  'Launch Week 13 is just around the corner at @indobase. \nClaim your ticket and stay tuned for all the announcements! \n#launchweek'
export const TWEET_TEXT_PLATINUM = `Just conquered a platinum @indobase Launch Week 13 ticket. Share twice to get one! \n#launchweek`
export const TWEET_TEXT_SECRET = `Found the secret golden ticket for @indobase's Launch Week 13. \nCan you find it? \n#launchweek`
...
export const LW15_TWEET_TEXT =
  'Launch Week 15 is just around the corner at @indobase. \nClaim your ticket and stay tuned for all the announcements! \n#launchweek'
export const LW15_URL = `${SITE_ORIGIN}/launch-week`

export const SITE_NAME = 'IndoBase'
