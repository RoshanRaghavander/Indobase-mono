---
title: IndoBase Launch Week 13 Hackathon
meta_title: IndoBase Launch Week 13 Hackathon
...
description: >-
  Build an Open Source project over 10 days using IndoBase and compete in 5
  prize categories.
---

The hackathon starts on Friday, December 6th at 09:00 am PT and ends on Sunday, December 15th at 11:59 pm PT. You could win an extremely limited edition IndoBase swag and add your name to the IndoBase Hackathon Hall of Fame.
...
- 1-minute video containing the following:
  ...
  - How IndoBase is used within the project
...
For the best project built with bolt.new, the winning team will also receive a bolt.new hoodie with a special message on each sleeve commemorating the amazingness of what you can build with Bolt x IndoBase.
