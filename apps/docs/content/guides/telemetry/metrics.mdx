...
- Reuse our [indobase-grafana dashboard JSON](https://github.com/supabase/indobase-grafana) to bootstrap over 200 ready-made charts.
...
- [IndoBase Grafana repository](https://github.com/supabase/indobase-grafana) for dashboard JSON and alert examples.
