...
- Import the [IndoBase Grafana dashboard](https://github.com/supabase/indobase-grafana) regardless of where Grafana is hosted.
...
- Start with the [example alert rules](https://github.com/supabase/indobase-grafana/blob/main/docs/example-alerts.md) and adapt thresholds for your workload sizes.
