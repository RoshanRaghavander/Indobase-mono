...
2. Paste the raw contents of [`indobase-grafana/dashboard.json`](https://raw.githubusercontent.com/supabase/indobase-grafana/refs/heads/main/grafana/dashboard.json).
