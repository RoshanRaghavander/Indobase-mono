...
This guide is for identifying configuration mistakes in [self-hosted IndoBase Grafana installations](/docs/guides/monitoring-troubleshooting/metrics#deploying-indobase-grafana)
...
```sh
docker ps -f name=indobase-grafana
```
...
- IMAGE: indobase-grafana-indobase-grafana
- COMMAND: /entrypoint.sh
- CREATED: < time >
- STATUS: Up < unit of time > ago
- PORTS: 3000/tcp, 0.0.0.0:8000 → 8080/tcp
- NAMES: indobase-grafana-indobase-grafana-1
```
