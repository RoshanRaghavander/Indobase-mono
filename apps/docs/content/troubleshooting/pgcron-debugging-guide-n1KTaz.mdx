...
Go to the [reports page](/dashboard/project/_/observability/database) (or [IndoBase Grafana](/docs/guides/monitoring-troubleshooting/metrics#deploying-indobase-grafana) if you have it setup), and check for signs of resource exhaustion. If it's clear your database is under pressure, consider upgrading your compute add-on or following the advice from one of the optimization guides:
