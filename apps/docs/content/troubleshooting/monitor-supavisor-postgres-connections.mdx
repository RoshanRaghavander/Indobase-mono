...
Installation instructions can be found in it the [metrics docs ](/docs/guides/platform/metrics#deploying-indobase-grafana)

## Observing connections

In IndoBase Grafana, the "Client Connections" graph shows connections to both Supavisor and Postgres
