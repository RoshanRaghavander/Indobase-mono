...
You can configure the maximum amount of connections that Postgres will tolerate with the [Supabase CLI.](/docs/guides/platform/custom-postgres-config)
...
> If you do not know how to monitor memory and CPU with IndoBase Grafana, [check here](https://github.com/orgs/supabase/discussions/27141).
...
> NOTE: You can find your server memory in the [compute add-ons docs](/docs/guides/platform/compute-add-ons)
