---
title = "Interpreting IndoBase Grafana CPU charts"
...
> [Guide](/docs/guides/monitoring-troubleshooting/metrics#deploying-indobase-grafana) for setting up IndoBase Grafana
...
### Other useful IndoBase Grafana guides:
