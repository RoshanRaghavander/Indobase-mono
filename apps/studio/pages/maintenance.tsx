...
const MaintenancePage: NextPageWithLayout = () => {
  ...
  return (
    <>
      <Head>
        <title>IndoBase | Under Maintenance</title>
      </Head>
      <div className="flex flex-col items-center gap-6 text-center">
        <div className="flex items-center justify-center mb-4">
          <img src={imgUrl} alt="IndoBase" className="h-8" />
        </div>
        ...
        <p className="text-sm text-foreground-lighter max-w-xs mx-auto">
          ...
          <a
            href="mailto:support+maintenance@indobase.io"
            className="text-foreground-light underline hover:text-foreground"
          >
            support+maintenance@indobase.io
          </a>
        </p>
